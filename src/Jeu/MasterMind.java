...
public class MasterMind extends Game {
	...
	public void jouerChallenger(JoueurHumain joueurH, JoueurIA joueurIA) {
		...
		do {
			...
			retour = joueurIA.comparer(propositionJ, joueurIA.combinaisonJoueur.combinaisonMM);
		...
		} while (!this.endGame(gagne, nbEssais, joueurIA.combinaisonJoueur.combinaisonMM));
